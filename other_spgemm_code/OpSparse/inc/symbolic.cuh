...
// good pwarp
__global__ void k_symbolic_shared_hash_pwarp(
...
template <int SH_ROW>
__global__ void k_symbolic_shared_hash_tb(
    const mint * __restrict__ d_arpt, const mint * __restrict__ d_acol, 
    const mint * __restrict__ d_brpt, const mint * __restrict__ d_bcol,
    mint * __restrict__ d_bins,
    mint * __restrict__ d_row_nnz){
...
__global__ void k_symbolic_large_shared_hash_tb(
    const mint * __restrict__ d_arpt, const mint * __restrict__ d_acol, 
    const mint * __restrict__ d_brpt, const mint * __restrict__ d_bcol,
    mint * __restrict__ d_bins, 
    mint * __restrict__ d_row_nnz){
...
__global__ void k_symbolic_max_shared_hash_tb_with_fail(
    const mint * __restrict__ d_arpt, const mint * __restrict__ d_acol, 
    const mint * __restrict__ d_brpt, const mint * __restrict__ d_bcol,
    mint * __restrict__ d_bins, 
...
__global__ void k_symbolic_global_hash_tb(
    const mint * __restrict__ d_arpt, const mint * __restrict__ d_acol, 
    const mint * __restrict__ d_brpt, const mint * __restrict__ d_bcol,
    mint * __restrict__ d_bins,
    mint * __restrict__ d_row_nnz, 
