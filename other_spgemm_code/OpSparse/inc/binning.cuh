...
__global__ void __launch_bounds__(1024,1) k_symbolic_binning(
...
__global__ void __launch_bounds__(1024,1) k_symbolic_binning2(
...
__global__ void __launch_bounds__(1024,1) k_binning_small(
    mint *d_bins, mint M){
...
__global__ void __launch_bounds__(1024,1) k_numeric_binning(
...
__global__ void __launch_bounds__(1024,1) k_numeric_binning2 (
    mint * __restrict__ d_row_nnz, 
    int M, 
    mint * __restrict__ d_bins, 
    mint * __restrict__ d_bin_size, 
